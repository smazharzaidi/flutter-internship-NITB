...
import 'package:flutter_application_3/app/modules/home/controllers/quote_controller.dart';
      ...
      body: Center(
        child: Obx(
          () {
            ...
            } else if (quoteController.quotes.value.isNotEmpty) {
              return ListView.builder(
                itemCount: quoteController.quotes.value.length,
                itemBuilder: (context, index) {
                  final quote = quoteController.quotes.value[index];
              ...
              onPressed: () {
                ...
                if (quoteText.isNotEmpty && authorText.isNotEmpty) {
                  final Quote newQuote = Quote(
                    id: quoteController.quotes.value.length + 1,
                    quote: quoteText,
                    author: authorText,
                  );
